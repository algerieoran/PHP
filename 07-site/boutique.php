...
// 1- Affichages des catégories des vetements :
$resultat = executeRequete("SELECT DISTINCT categorie FROM produit");  // DISTINCT pour dédoublonner les catégories existantes
